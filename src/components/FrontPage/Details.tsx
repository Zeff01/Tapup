...
export default function Details() {
    return (
        <section className="bg-customGray flex flex-col items-center pt-10 pb-20">
            <div className="px-4 flex flex-col gap-4 w-full lg:w-[1000px]">
            ...
            <div className="flex flex-col md:flex-row w-screen lg:w-[1000px] gap-4 py-10 items-center justify-center md:items-start md:justify-normal">
                <div className="h-[400px] basis-1/3 flex flex-col gap-y-4 max-w-[300px]">
                    <div className="basis-1/2 bg-customBlack text-white px-6 py-8 rounded-md shadow-md">
                    ...
                    <div className="basis-1/2 bg-white text-customBlack px-6 py-8 rounded-md shadow-md">
                        <p className="text-lg pb-4">Custom Made Card</p>
                        <p className="text-customTextGray">Lorem Ipsum is simply dummy text of the printing and typesetting industry. </p>
                    </div>
                </div>
                <div className="h-[400px] max-w-[300px] basis-1/3 bg-customBlack text-white px-6 py-8 rounded-md shadow-md flex flex-col justify-end">
                    <p className="text-lg pb-4">Custom Made Card</p>
                    <p className="text-[#b4b4b4]">Lorem Ipsum is simply dummy text of the printing and typesetting industry. </p>
                </div>
                <div className="h-[400px] max-w-[300px] basis-1/3 flex flex-col gap-y-4">
