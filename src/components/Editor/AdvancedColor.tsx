...
{ 
    ...
    to: backgroundColor.split(',')[2].substring(0, backgroundColor.split(',')[2].length -1)
} :
{
    from: '#ffffff',
    to: '#000000'
...
return (
    ...
    <AlertDialogTrigger asChild>
        <Button className="text-[12px] w-full text-[#454545] border-gray-200" variant={"outline"}>Advance Colors</Button>
    </AlertDialogTrigger>
    <AlertDialogContent>
        <AlertDialogHeader>
        <AlertDialogTitle>Advanced Background Color Picker</AlertDialogTitle>
        <AlertDialogDescription>
            You can choose two color combination, with multiple linear directions.
        </AlertDialogDescription>
        <div>
