...
export default function Accordions() {
    ...
    return (
        <section className="w-[250px] px-4 py-12 flex flex-col gap-1 overflow-y-scroll" id="edit-accordion">
            <p className="text-sm" id="font-style">Font Styles</p>
            <FontAccordion />
            <TextColorAccordion />
            <br />
            
            <p className="text-sm" id="card-infos">Card Infos</p>
            <NameAccordion />
            <PositionAccordion />
            <CompanyAccordion />
            <AddressAccordion />
            ...
            <p className="text-sm"  id="images">Images</p>
            <ProfileImageAccordion />
            <CoverAccordion />
            <br />
            
            <p className="text-sm" id="background">Background</p>
            <BackgroundColorAccordion />
            <br />

            <p className="text-sm" id="contacts">Contacts</p>
